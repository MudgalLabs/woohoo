        ...
        <section className="section isnot-section" id="isnot">
            <div className="wrap">
                <div className="section-head">
                    ...
                    <p>
                        Woohoo is small on purpose. A founder built it for their
                        own marketing, then opened it up. Here&rsquo;s what it
                        does — and what it refuses to become.
                    </p>
                </div>
                        ...
                        <ul className="is-list">
                            ...
                            <li>
                                <span>
                                    ...
                                    overdue, getting cold — and nothing else.
                                </span>
                            </li>
                            <li>
                                <span>
